...
const Header = () => {
    ...
    return (
        <div className='mt-12 px-2 sm:px-12 md:mt-0 lg:min-h-[60vh] bg-[#13131310] rounded-3xl justify-between flex md:flex-row flex-col-reverse lg:px-32 items-center gap-8 py-8 lg:py-0'>
            ...
            <img className=' md:w-2/5 lg:w-5/12 object-cover rounded' src={headerimg} alt="" />
        </div>
    );
};
